  ...
  (
      ...
      useEffect(() => {
          ...
          React.Children.forEach(children, (child, index) => {
              if (isMarker(child) && child.props.pinColor === "red") {

                  redRawData.push(markerToGeoJSONFeature(child, index));
              } else if (isMarker(child) && child.props.pinColor === "blue") {
      ...
      const _onClusterPress = (cluster) => () => {
          // const children = redSuperCluster.getLeaves(cluster.id, Infinity);
